...
values
    ('97357bea-d65c-4be1-b5e7-3ed8c0165a5a', 'f437e4a1-0f1d-4af8-aadd-c038e9d9a7c7', 'TENANT_ADMIN', 'Tenant Admin', 'Tenant-scoped academic administrator.', 'TENANT',
     array['role:view','role:create','role:update','role:assign','subject:view','subject:create','subject:update','subject:delete','academic-period:view','academic-period:create','academic-period:update','academic-period:delete','group-class:view','group-class:create','group-class:update','group-class:delete','group-class-member:view','group-class-member:invite','group-class-member:update','group-class-member:delete','group-class-join-code:view','group-class-join-code:create','group-class-join-code:update','group-class-join-code:delete','grounding:view','grounding:create','grounding:update','grounding:delete','training-activity:view','training-activity:create','training-activity:update','training-activity:delete','training-activity-assignment:view','training-activity-assignment:create','training-activity-assignment:update','training-activity-assignment:delete','conversation:view'], 80, true, true, true),
    ('e034005c-3565-4fe6-a23b-8fe1ccf85584', 'f437e4a1-0f1d-4af8-aadd-c038e9d9a7c7', 'PROFESSOR', 'Professor', 'Professor operating inside assigned group classes.', 'GROUP_CLASS',
     array['group-class:view','group-class:update','group-class-member:view','group-class-member:invite','group-class-member:update','group-class-join-code:view','group-class-join-code:create','group-class-join-code:update','group-class-join-code:delete','grounding:view','grounding:create','grounding:update','grounding:delete','training-activity:view','training-activity:create','training-activity:update','training-activity:delete','training-activity-assignment:view','training-activity-assignment:create','training-activity-assignment:update','training-activity-assignment:delete','conversation:view'], 60, true, true, true),
