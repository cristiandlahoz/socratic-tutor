...
export interface AsciifyInstance {
  ...
  /** Upload a source canvas painted without the experimental HTML canvas API. */
  updateSource: () => void;
...
export function createAsciify(
  ...
  themeObserver.observe(document.documentElement, {
    attributes: true,
    attributeFilter: ["class", "style", "data-theme", "data-theme-preference"],
  });
