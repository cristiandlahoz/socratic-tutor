...
public interface StudentMisconceptionRepository extends JpaRepository<StudentMisconception, Long> {

    List<StudentMisconception> findByClientIdOrderByLastSeenAtDesc(UUID clientId);

    Optional<StudentMisconception> findByClientIdAndMisconceptionKey(UUID clientId, String misconceptionKey);
