...
public final class CodeMessageList extends Component implements HasSize {
  ...
  public void setItems(Collection<CodeMessageListItem> items) {
    ...
    items.forEach(
        item -> Objects.requireNonNull(item, "Can't include null items in CodeMessageList."));
  ...
  private void scheduleUpdate() {
    ...
    getElement()
        .getNode()
        .runWhenAttached(ui -> ui.beforeClientResponse(this, ctx -> updateClient()));
  }
