...
public class NavigationRegistry {
    private final List<NavigationEntry> entries = List.of(
        new NavigationEntry("Administración",
                SystemAdminWorkspaceView.class,
                () -> new Icon(VaadinIcon.HOME),
                ContextLevel.PLATFORM,
                AppPermission.TENANT_VIEW,
                10),
        new NavigationEntry("Panel profesoral",
                ProfessorWorkspaceView.class,
                () -> new Icon(VaadinIcon.ACADEMY_CAP),
                ContextLevel.GROUP_CLASS,
                AppPermission.GROUP_CLASS_MEMBER_VIEW,
                11),
        new NavigationEntry("Panel estudiantil",
                StudentWorkspaceView.class,
                () -> new Icon(VaadinIcon.USER),
                ContextLevel.GROUP_CLASS,
                AppPermission.TRAINING_ACTIVITY_ASSIGNMENT_VIEW,
                12),
        new NavigationEntry("Institución",
                TenantAdminWorkspaceView.class,
                () -> new Icon(VaadinIcon.INSTITUTION),
                ContextLevel.TENANT,
                AppPermission.GROUP_CLASS_CREATE,
                20),
        new NavigationEntry("Matriz de roles",
                RoleMatrixView.class,
                () -> new Icon(VaadinIcon.TABLE),
                ContextLevel.PLATFORM,
                AppPermission.ROLE_VIEW,
                22),
        new NavigationEntry("Roles de tenant",
                TenantMemberRoleAssignmentView.class,
                () -> new Icon(VaadinIcon.KEY),
                ContextLevel.TENANT,
                AppPermission.ROLE_ASSIGN,
                24),
        new NavigationEntry("Roles de clase",
                GroupClassMemberRoleAssignmentView.class,
                () -> new Icon(VaadinIcon.KEY),
                ContextLevel.TENANT,
                AppPermission.ROLE_ASSIGN,
                26),
