...
@Getter
@Setter
public class EvaluationQuestionExampleEntity {
  ...
  protected EvaluationQuestionExampleEntity() {}

  public static EvaluationQuestionExampleEntity create(
      EvaluationRevisionEntity revision,
      String exampleKey,
      int ordinal,
      String guidance,
      Map<String, Object> rubric) {
    var entity = new EvaluationQuestionExampleEntity();
