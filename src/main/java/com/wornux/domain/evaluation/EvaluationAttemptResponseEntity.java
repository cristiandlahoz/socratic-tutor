...
@Getter
@Setter
public class EvaluationAttemptResponseEntity {
  ...
  private EvaluationAttemptQuestionEntity attemptQuestion;
  ...
  protected EvaluationAttemptResponseEntity() {}

  public static EvaluationAttemptResponseEntity answer(
      EvaluationAttemptQuestionEntity attemptQuestion, String freeText, List<String> selectedOptions) {
    var entity = new EvaluationAttemptResponseEntity();
