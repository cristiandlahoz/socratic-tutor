...
public record DocumentCatalogEntry(String title, String topic, String summary, List<String> tags, List<String> entities,
    ...
    public DocumentCatalogEntry normalized(int maxTags, int maxQuestionExamples) {
        return new DocumentCatalogEntry(clean(title, 96),
                clean(topic, 180),
                clean(summary, 360),
