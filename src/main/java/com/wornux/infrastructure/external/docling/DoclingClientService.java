...
public class DoclingClientService {
  ...
  public DoclingClientService(DocumentIngestionProperties properties) {
    ...
    log.info(
        "docling_chunking_config base_url={} tokenizer={} max_tokens={} merge_peers={}"
  ...
  public DoclingConversionResult convertPdfToMarkdownAndChunks(String filename, byte[] content) {
    try {
      ...
      log.info(
          "docling_ingest_trace filename={} chunks_count={} chunk_docs_count={} chunk_md_present={}"
              + " convert_md_present={} final_md_length={}",
          filename,
