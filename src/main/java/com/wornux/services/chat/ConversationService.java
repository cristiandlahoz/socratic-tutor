...
public class ConversationService {
    ...
    public List<ConversationSummary> listConversations(UUID clientId) {
        return chatRepository.findByClientIdOrderByUpdatedAtDescCreatedAtDesc(clientId)
                .stream()
    ...
    public ResolvedConversation resolveActiveConversation(UUID clientId, UUID requestedConversationId) {
        var conversations = chatRepository.findByClientIdOrderByUpdatedAtDescCreatedAtDesc(clientId)
                .stream()
                .map(this::toConversationSummary)
                .toList();
    ...
    public ChatCompactionStatus getCompactionStatus(UUID clientId, UUID conversationId) {
        ...
        return new ChatCompactionStatus(true,
                transcript.getCompactionLevel(),
                transcript.getCompactedFromTranscriptId());
    }
