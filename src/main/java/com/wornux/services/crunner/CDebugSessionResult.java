...
public record CDebugSessionResult(boolean valid, List<CDiagnostic> diagnostics, List<CDebugSnapshot> snapshots,
        String compiler, long elapsedMs, String sourceHash) {
