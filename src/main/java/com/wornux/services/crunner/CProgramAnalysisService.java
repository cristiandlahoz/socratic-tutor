...
public class CProgramAnalysisService {
  ...
  public CProgramAnalysisService(
      DockerGccCCompilerAdapter compiler, CProgramAnalysisProperties properties) {
  ...
  public CValidationResult validateSyntax(CSourceRequest request) {
    ...
    var cacheKey =
        new CValidationCacheKey(
            sourceHash, normalizedRequest.standard(), normalizedRequest.filename(), compiler.cacheKey());
