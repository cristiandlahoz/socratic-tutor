...
public class CExamplePreparationService {
    ...
    private CExamplePreparationResult normalize(CExamplePreparationResult result, String fallbackSource) {
        if (result == null) {
    ...
    private static CExamplePreparationResult notRunnable(String source, String risk) {
        return new CExamplePreparationResult(CExamplePreparationStatus.NOT_RUNNABLE,
                "",
                List.of(),
