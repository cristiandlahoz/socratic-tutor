...
public record CExamplePreparationResult(CExamplePreparationStatus status, String source, List<String> changes,
        String educationalNote, String risk) {
    ...
    public static CExamplePreparationResult readyOriginal(String source) {
        return new CExamplePreparationResult(CExamplePreparationStatus.READY,
                source,
