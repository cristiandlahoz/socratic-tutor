...
public record EvaluationGradeResult(BigDecimal overallScore, String summary, List<String> strengths,
        List<String> weakConcepts, List<String> activeMisconceptions, List<String> tutorRecommendations,
    ...
    public EvaluationGradeResult {
        ...
        tutorRecommendations = tutorRecommendations == null ? List.of() : List.copyOf(tutorRecommendations);
