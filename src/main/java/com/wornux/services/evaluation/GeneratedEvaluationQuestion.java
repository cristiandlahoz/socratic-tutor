...
public record GeneratedEvaluationQuestion(String questionKey, String blueprintKey, int ordinal, String topicKey,
        String difficulty, String prompt, List<String> options, Map<String, Object> expectedAnswer,
        Map<String, Object> rubric, List<String> sourceExampleIds) {
