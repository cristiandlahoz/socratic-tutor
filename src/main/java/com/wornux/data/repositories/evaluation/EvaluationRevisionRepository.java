...
public interface EvaluationRevisionRepository
    extends JpaRepository<EvaluationRevision, UUID> {

  Optional<EvaluationRevision> findFirstByEvaluationOrderByVersionDesc(
