...
public class DocumentSegment {
    ...
    public static DocumentSegment createDraft(
            Document document,
            int ordinal,
            String headingPath,
            String content,
        ...
        entity.tokenCount = tokenCount == null ? EditableSegmentViewModel.approximateTokens(content) : tokenCount;
    ...
    public void applyReview(EditableSegmentViewModel segment) {
        ...
        this.tokenCount = segment.tokenCount() == null
                ? EditableSegmentViewModel.approximateTokens(segment.content())
                : segment.tokenCount();
    ...
    public EditableSegmentViewModel toViewModel() {
