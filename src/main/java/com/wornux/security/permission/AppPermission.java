...
public enum AppPermission {
    ...
    GROUNDING_VIEW(AppResource.GROUNDING, AppAction.VIEW, "grounding:view"),
    GROUNDING_CREATE(AppResource.GROUNDING, AppAction.CREATE, "grounding:create"),
    GROUNDING_UPDATE(AppResource.GROUNDING, AppAction.UPDATE, "grounding:update"),
    GROUNDING_DELETE(AppResource.GROUNDING, AppAction.DELETE, "grounding:delete"),
