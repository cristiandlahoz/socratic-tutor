...
class QuestionAnswerProfileSignalServiceTest {
  ...
  private final QuestionAnswerProfileSignalService service =
      new QuestionAnswerProfileSignalService();
                    ...
                    new StudentQuestion(
                        ...
                        List.of(
                            new StudentQuestionOption(
                                "Pistas guiadas", "Prefiero hints antes que respuesta"),
            ...
            new StudentQuestionResponse(
                List.of(
                    new StudentQuestionAnswer(
                        "q1",
                        List.of("Pistas guiadas", "Loops"),
                        "Necesito un ejemplo paso a paso"))),
            Instant.now());
            ...
            new StudentQuestionSet(
                ...
                List.of(
                    new StudentQuestion(
                        ...
                        false))),
            new StudentQuestionResponse(
                List.of(new StudentQuestionAnswer("q1", List.of("Analogias"), ""))),
            Instant.now());
