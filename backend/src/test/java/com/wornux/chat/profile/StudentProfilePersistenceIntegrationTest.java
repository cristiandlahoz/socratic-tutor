...
class StudentProfilePersistenceIntegrationTest {
    ...
    void applyTurnSignals_persists_profile_topics_and_misconceptions() {
        ...
        var update = new TurnProfileUpdate(
                null,
                UUID.randomUUID(),
                List.of(TopicKey.LOOPS),
                List.of(new TurnProfileUpdate.LevelSignal(TopicKey.LOOPS, TurnProfileUpdate.SignalDirection.DOWN, "confusion")),
                List.of(new TurnProfileUpdate.MisconceptionObservation(TopicKey.LOOPS, "counter_vs_accumulator", "Confunde contador y acumulador", new BigDecimal("0.800"))),
                "es",
                HelpMode.GUIDED,
                true,
