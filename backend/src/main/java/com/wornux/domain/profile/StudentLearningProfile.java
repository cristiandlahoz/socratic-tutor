...
public record StudentLearningProfile(
    List<LearningSignal> observedCompetencies,
    List<LearningSignal> strengths,
    List<LearningSignal> activeMisconceptions,
    List<LearningSignal> weakConcepts,
    List<String> helpPreferences,
    String preferredLanguage,
    List<String> recentEvidenceIds,
  ...
  public StudentLearningProfile {
    ...
    preferredLanguage =
        preferredLanguage == null || preferredLanguage.isBlank() ? "es" : preferredLanguage;
    ...
    tutorAdaptationGuidance =
        tutorAdaptationGuidance == null ? List.of() : List.copyOf(tutorAdaptationGuidance);
  }
