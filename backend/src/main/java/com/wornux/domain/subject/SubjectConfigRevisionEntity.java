...
@Getter
@Setter
public class SubjectConfigRevisionEntity {
  ...
  protected SubjectConfigRevisionEntity() {}

  public static SubjectConfigRevisionEntity create(
      ...
      String createdBy) {
    var entity = new SubjectConfigRevisionEntity();
