package com.wornux.presentation.documentingest.ui;
...
public class DocumentStatusPanel extends Composite<Div> {
  ...
  public void setStatus(
      String fileName, String stageLabel, boolean busy, boolean indexed, String failureMessage) {
    title.setText(fileName == null || fileName.isBlank() ? "Sin documento cargado" : fileName);
    message.setText(
        stageLabel == null || stageLabel.isBlank() ? "Sube un PDF para comenzar." : stageLabel);
