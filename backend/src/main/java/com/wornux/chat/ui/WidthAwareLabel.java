...
public class WidthAwareLabel extends Composite<Span> {
    ...
    private static final int DEFAULT_SAFETY_PIXELS = 12;

    private String fullText = "";
    private int safetyPixels = DEFAULT_SAFETY_PIXELS;
    ...
    public void setSafetyPixels(int safetyPixels) {
        this.safetyPixels = Math.max(0, safetyPixels);
        getContent().getElement().setProperty("__widthAwareSafety", this.safetyPixels);
        refreshDisplay();
    }
