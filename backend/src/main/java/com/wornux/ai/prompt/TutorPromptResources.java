...
public class TutorPromptResources {
  ...
  private static final String DIRECT_REFERENCE_EXAMPLES =
      "classpath:/tutor/examples/direct-reference.st";
  private static final String EXERCISE_GUIDANCE_EXAMPLES =
      "classpath:/tutor/examples/exercise-guidance.st";
  private static final String GUARD_NOT_SAFE = "classpath:/tutor/policies/guard-not-safe.st";
  private static final String GUARD_IMPERSONATION =
      "classpath:/tutor/policies/guard-impersonation.st";
  private static final String GUARD_OUT_OF_SCOPE =
      "classpath:/tutor/policies/guard-out-of-scope.st";
  private static final String GUARD_CLASSIFIER = "classpath:/tutor/policies/guard-classifier.st";
  private static final String ROUTING_CLASSIFIER =
      "classpath:/tutor/policies/routing-classifier.st";
  private static final String ROUTING_DIRECT_REFERENCE =
      "classpath:/tutor/policies/routing-direct-reference.st";
  private static final String ROUTING_EXERCISE_GUIDANCE =
      "classpath:/tutor/policies/routing-exercise-guidance.st";
  private static final String ROUTING_DEBUG_MY_ATTEMPT =
      "classpath:/tutor/policies/routing-debug-my-attempt.st";
